...
export type Tdiscipline = 'Журналистика'  | 'Дизайн'  | 'Технология КДДТ'  | 'Технология ТТТ'  | 'Роботехника'  | 'ОБЖ'  | 'Физкультура'  | 'Химия'  | 'Биология'  | 'Экология'  | 'География'  | 'Обществознание'  | 'Экономика'  | 'Право'  | 'Политология'  | 'Социология'  | 'Психология'  | 'Финансовая грамотность'  | 'Предпринимательство'  | 'Русский'  | 'Английский'  | 'Немецкий'  | 'Китайский'  | 'Французский'  | 'Итальянский'  | 'Испанский'  | 'История'  | 'МХК'  | "Литература"  | "Философия"  | 'Востоковедение'  | 'Математика'  | 'Информатика'  | 'Физика'  | 'Астрономия'  | 'Информационная безопасность';

export const disciplines = {
    t: ['Математика', 'Информатика', 'Физика', 'Астрономия', 'Информационная безопасность'],
    g: ['История', 'МХК', "Литература", "Философия", 'Востоковедение'],
    l: ['Русский', 'Английский', 'Немецкий', 'Китайский', 'Французский', 'Итальянский', 'Испанский'],
    s: ['Обществознание', 'Экономика', 'Право', 'Политология', 'Социология', 'Психология', 'Финансовая грамотность', 'Предпринимательство'],
    e: ['Химия', 'Биология', 'Экология', 'География'],
    p: ['Журналистика', 'Дизайн', 'Технология КДДТ', 'Технология ТТТ', 'Роботехника', 'ОБЖ', 'Физкультура']
}
